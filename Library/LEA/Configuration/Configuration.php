...
class Configuration {
    ...
    const CACHED_FILE = 'Data/Temporary/Configuration/configuration.txt';
     ...
     * @var string
     */
    protected $cachedConfigurationFile = '';
    ...
    public function getConfiguration() {
        if (!file_exists($this->cachedConfigurationFile)) $this->initialize();
        return unserialize(file_get_contents($this->cachedConfigurationFile));
    }
